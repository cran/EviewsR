...
vignette: >
  %\VignetteIndexEntry{EviewsR: A Seamless Integration of Eviews and R}
...
# 1 EviewsR <img src="https://github.com/sagirumati/EviewsR/tree/master/inst/EVIEWS/EviewsR.png" align="right" width="120" />
...
<img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//eviewsreviewsrpage-xx.png" alt="EViews graphs imported automatically by fig-EviewsR chunk" width="45%" height="20%" /><img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//eviewsreviewsrpage-yy.png" alt="EViews graphs imported automatically by fig-EviewsR chunk" width="45%" height="20%" />
<p class="caption">
Figure 8.1: EViews graphs imported automatically by fig-EviewsR chunk
</p>
...
<table>
<caption>Table 8.1: Selected cells of EViews table object</caption>
<tbody>
<tr class="odd">
...
### 8.2.1 The create\_object() function
...
### 8.2.2 The eviews\_graph() function
...
<img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//eviewsgraph-eviewsrpage-x.png" alt="Graphs of existing EViews series objects imported by fig-eviewsGraph chunk" width="45%" height="30%" /><img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//eviewsgraph-eviewsrpage-y.png" alt="Graphs of existing EViews series objects imported by fig-eviewsGraph chunk" width="45%" height="30%" />
<p class="caption">
Figure 8.2: Graphs of existing EViews series objects imported by
...
<img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//eviewsgraph1-eviewsgraph1-xy.png" alt="Graphs of an R dataframe imported by fig-eviewsGraph1 chunk" width="90%" height="70%" />
<p class="caption">
Figure 8.3: Graphs of an R dataframe imported by fig-eviewsGraph1 chunk
</p>

### 8.2.3 The eviews\_import() function
...
### 8.2.4 The eviews\_pagesave() function
...
### 8.2.5 The eviews\_wfcreate() function
...
### 8.2.6 The eviews\_wfsave() function
...
### 8.2.7 The exec\_commands() function
...
### 8.2.8 The export\_dataframe() function
...
### 8.2.9 The import\_equation() function
...
### 8.2.10 The import\_graph() function

Import EViews graph objects(s) into R, R Markdown or Quarto.

    import_graph(wf = "eviewsr_workfile")

<img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//fig-importgraph-eviewsrpage-xx.png" alt="EViews graphs imported using import\_graph() function" width="45%" height="20%" /><img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//fig-importgraph-eviewsrpage-yy.png" alt="EViews graphs imported using import\_graph() function" width="45%" height="20%" />
<p class="caption">
Figure 8.4: EViews graphs imported using import\_graph() function
</p>
...
<img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//fig-importgraph1-eviewspage-x_graph.png" alt="EViews graphs that begin with X imported using import\_graph() function" width="45%" height="20%" /><img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//fig-importgraph1-eviewspage1-x_graph.png" alt="EViews graphs that begin with X imported using import\_graph() function" width="45%" height="20%" />
<p class="caption">
Figure 8.5: EViews graphs that begin with X imported using
import\_graph() function
</p>

### 8.2.11 The import\_kable() function
...
<table>
<caption>
Table 8.2: Selected cells of EViews table imported using import\_kable()
function
</caption>
<thead>
<tr>
...
### 8.2.12 The import\_series() function
...
### 8.2.13 The import\_table() function
...
### 8.2.14 The import\_workfile() function
...
<img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//fig-importworkfile-eviewsrpage-xx.png" alt="EViews graphs automatically imported by import\_workfile() function" width="45%" height="20%" /><img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures//fig-importworkfile-eviewsrpage-yy.png" alt="EViews graphs automatically imported by import\_workfile() function" width="45%" height="20%" />
<p class="caption">
Figure 8.6: EViews graphs automatically imported by import\_workfile()
function
</p>
...
<img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures/fig-rwalk-1.png" alt="Plots of imported EViews random walk series objects" width="45%" height="20%" /><img src="https://github.com/sagirumati/EviewsR/tree/master/inst/figures/fig-rwalk-2.png" alt="Plots of imported EViews random walk series objects" width="45%" height="20%" />
<p class="caption">
Figure 8.7: Plots of imported EViews random walk series objects
</p>
